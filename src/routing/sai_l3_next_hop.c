                                 ...
                                 const char *p_trace_str)
{
    ...
    if (p_next_hop->key.nh_type == SAI_NEXT_HOP_IP) {
                                           ...
                                           bool is_create_req)
{
    ...
    if (p_nh_info->key.nh_type == SAI_NEXT_HOP_IP) {
                                            ...
                                            sai_fib_nh_t **p_out_next_hop_node)
{
    ...
    p_nh_node = sai_fib_ip_next_hop_node_get (p_nh_info->key.rif_id,
                                             ...
                                             const sai_attribute_t *attr_list)
{
    ...
    do {
        ...
        if (nh_info.key.nh_type == SAI_NEXT_HOP_IP) {
...
static sai_status_t sai_fib_next_hop_remove (sai_object_id_t next_hop_id)
{
    ...
    do {
        ...
        if (p_nh_node->key.nh_type == SAI_NEXT_HOP_IP) {
