                                            ...
                                            const sai_attribute_t *attr_list)
{
    ...
    sai_fdb_flush_entry_type_t flush_type = SAI_FDB_FLUSH_ENTRY_DYNAMIC;
...
{
    return sai_fdb_write_registered_entry_into_cache (fdb_entry);
}

sai_status_t sai_l2_deregister_fdb_entry (const sai_fdb_entry_t *fdb_entry)
{
    return sai_fdb_remove_registered_entry_from_cache (fdb_entry);
}
