                                      ...
                                      const sai_attribute_t *attr_list)
{
    ...
    do {
        ...
        p_stp_info->stp_inst_id = sai_uoid_create (SAI_OBJECT_TYPE_STP_INSTANCE, npu_object_id);
...
sai_status_t sai_stp_init (void)
{
    ...
    do {
        ...
        g_def_stp_id = sai_uoid_create (SAI_OBJECT_TYPE_STP_INSTANCE, def_stp_id);

        l3_stp_inst = sai_uoid_create (SAI_OBJECT_TYPE_STP_INSTANCE, l3_stp_id);
                                   ...
                                   sai_object_id_t *p_stp_id)
{
    ...
    *p_stp_id = sai_uoid_create (SAI_OBJECT_TYPE_STP_INSTANCE, npu_object_id);
...
sai_status_t sai_l2_stp_default_instance_id_get (sai_attribute_t *attr)
{
    ...
    attr->value.oid = sai_uoid_create (SAI_OBJECT_TYPE_STP_INSTANCE, def_stp_id);
