...
class saiL3NeighborTest : public saiL3Test
{
    public:
        ...
        static const unsigned int default_fdb_attr_count = 3;
...
sai_fdb_api_t* saiL3NeighborTest::p_sai_fdb_api_table = NULL;
 ...
 */
sai_status_t saiL3NeighborTest::sai_test_neighbor_fdb_entry_create (
                                                       const char *p_mac_str,
                                                       unsigned int vlan_id,
                                                       unsigned int port)
{
 ...
 */
sai_status_t saiL3NeighborTest::sai_test_neighbor_fdb_entry_remove (
                                                       const char *p_mac_str,
                                                       unsigned int vlan_id)
{
    sai_fdb_entry_t    fdb_entry;
