...
TEST_F(samplepacketTest, sample_set) {
    ...
    EXPECT_EQ (SAI_STATUS_SUCCESS, sai_rc);
    EXPECT_EQ (attr[0].value.s32, SAI_SAMPLEPACKET_SLOW_PATH);
...
TEST_F(samplepacketTest, flow_based) {
    ...
    EXPECT_EQ (SAI_STATUS_SUCCESS, p_sai_acl_api_tbl->delete_acl_entry(acl_rule_id));
    ...
    EXPECT_EQ (SAI_STATUS_SUCCESS, p_sai_acl_api_tbl->delete_acl_entry(acl_rule_id));
    EXPECT_EQ (SAI_STATUS_SUCCESS, p_sai_acl_api_tbl->delete_acl_entry(acl_rule_id2));

    EXPECT_EQ (SAI_STATUS_SUCCESS, p_sai_acl_api_tbl->delete_acl_table (acl_table_id));
...
TEST_F(samplepacketTest, flow_based_duplicate) {
    ...
    EXPECT_EQ (SAI_STATUS_SUCCESS, p_sai_acl_api_tbl->delete_acl_entry(acl_rule_id_1));
    EXPECT_EQ (SAI_STATUS_SUCCESS, p_sai_acl_api_tbl->delete_acl_entry(acl_rule_id_2));
    EXPECT_EQ (SAI_STATUS_SUCCESS, p_sai_acl_api_tbl->delete_acl_table (acl_table_id));
