...
TEST_F(fdbInit, sai_fdb_single_notification_callback)
{
    ...
    sai_fdb_create_registered_entry(fdb_entry,SAI_FDB_ENTRY_DYNAMIC, port_id_1, SAI_PACKET_ACTION_FORWARD);
...
TEST_F(fdbInit, sai_fdb_multi_notification_callback)
{
    ...
    sai_fdb_create_registered_entry(fdb_entry1, SAI_FDB_ENTRY_DYNAMIC, port_id_1, SAI_PACKET_ACTION_FORWARD);
    sai_fdb_create_registered_entry(fdb_entry2, SAI_FDB_ENTRY_DYNAMIC, port_id_2, SAI_PACKET_ACTION_FORWARD);
