...
TEST_F(fdbInit, create_fdb_entry)
{
    ...
    attr_list[1].value.s32 = SAI_FDB_ENTRY_DYNAMIC;
    ASSERT_EQ(SAI_STATUS_MANDATORY_ATTRIBUTE_MISSING,
              sai_fdb_api_table->create_fdb_entry(
                                 (const sai_fdb_entry_t*)&fdb_entry,
                                  2,
    ...
    sai_fdb_entry_create(SAI_FDB_ENTRY_STATIC, port_id_1, SAI_PACKET_ACTION_FORWARD);
    sai_set_test_fdb_entry(&fdb_entry);
    ...
    ASSERT_EQ(SAI_FDB_ENTRY_STATIC, get_attr_list[0].value.s32);
...
TEST_F(fdbInit, flush_all_fdb_entries_by_port)
{
    ...
    sai_fdb_entry_create(SAI_FDB_ENTRY_DYNAMIC, port_id_1, SAI_PACKET_ACTION_DROP);
    sai_set_test_fdb_entry(&fdb_entry);
    memset(get_attr_list,0, sizeof(get_attr_list));
...
TEST_F(fdbInit, flush_all_fdb_entries_by_lag)
{
    ...
    sai_fdb_entry_create(SAI_FDB_ENTRY_DYNAMIC, lag_id, SAI_PACKET_ACTION_FORWARD);
...
TEST_F(fdbInit, flush_all_fdb_entries_by_vlan)
{
    ...
    sai_fdb_entry_create(SAI_FDB_ENTRY_DYNAMIC, port_id_2, SAI_PACKET_ACTION_LOG);
    sai_set_test_fdb_entry(&fdb_entry);
    memset(get_attr_list,0, sizeof(get_attr_list));
    memset(flush_attr,0, sizeof(flush_attr));
...
TEST_F(fdbInit, flush_all_fdb_entries_by_port_vlan)
{
    ...
    sai_fdb_entry_create(SAI_FDB_ENTRY_DYNAMIC, port_id_1, SAI_PACKET_ACTION_FORWARD);
    sai_set_test_fdb_entry(&fdb_entry);
    memset(get_attr_list,0, sizeof(get_attr_list));
    memset(flush_attr,0, sizeof(flush_attr));
...
TEST_F(fdbInit, flush_supported_types)
{
    ...
    sai_fdb_entry_create(SAI_FDB_ENTRY_STATIC, port_id_1, SAI_PACKET_ACTION_FORWARD);
    flush_attr[0].value.s32 = SAI_FDB_FLUSH_ENTRY_STATIC;
